...
const Bookmarks: React.FunctionComponent = () => {
  const [users, setUsers] = useState<User[]>([]); // This will store the users data
...
const Bookmarkpage: React.FunctionComponent<PaginationProps> = ({ totalItems = 0, itemsPerPage = 8, onPageChange }) => {
