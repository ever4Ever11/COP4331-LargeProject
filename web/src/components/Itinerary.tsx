...
const Itinerary: React.FunctionComponent<ItineraryProps> = ({created, parameters, content}) => {
  ...
  return (
    ...
    <div className="text-left">
      <p><span className="font-semibold text-white py-2">📅 Created:</span><span className="px-2 font-semibold text-white">{formatedDate}</span></p>
      ...
      <p><span className="font-semibold text-white py-2">🧗 Travel Style:</span><span className="px-2 font-semibold text-white">{parameters.travelStyle}</span></p>
    </div>
    <div>
      <img 
      src={Img}
